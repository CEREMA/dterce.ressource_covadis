-- FUNCTION: w_adl_delegue.set_geom_bdtopo_30(character varying, character varying, integer)

-- DROP FUNCTION w_adl_delegue.set_geom_bdtopo_30(character varying, character varying, integer);

CREATE OR REPLACE FUNCTION w_adl_delegue.set_geom_bdtopo_30(
...
ALTER FUNCTION w_adl_delegue.set_geom_bdtopo_30(character varying, character varying, integer)
    OWNER TO postgres;

COMMENT ON FUNCTION w_adl_delegue.set_geom_bdtopo_30(character varying, character varying, integer)
