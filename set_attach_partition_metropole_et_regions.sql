-- FUNCTION: w_adl_delegue.set_attach_partition_metropole_et_regions(character varying, character varying, boolean)

-- DROP FUNCTION w_adl_delegue.set_attach_partition_metropole_et_regions(character varying, character varying, boolean);

CREATE OR REPLACE FUNCTION w_adl_delegue.set_attach_partition_metropole_et_regions(
...
ALTER FUNCTION w_adl_delegue.set_attach_partition_metropole_et_regions(character varying, character varying, boolean)
    OWNER TO postgres;

COMMENT ON FUNCTION w_adl_delegue.set_attach_partition_metropole_et_regions(character varying, character varying, boolean)
