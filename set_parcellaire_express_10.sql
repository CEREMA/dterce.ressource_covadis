...
CREATE OR REPLACE FUNCTION w_adl_delegue.set_parcellaire_express_10(
...
AS $function$
/*
[ADMIN - PEPCI] - Administration d´un millesime du Parcellaire Express une fois son import réalisé
...
---- B.5.2 Création de la clé primaire selon IGN
