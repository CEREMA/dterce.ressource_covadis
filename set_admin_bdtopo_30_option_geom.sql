CREATE OR REPLACE FUNCTION w_adl_delegue.set_admin_bdtopo_30_option_geom(emprise character varying, millesime character varying, projection integer DEFAULT 2154)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
/*
...
COMMENT ON FUNCTION w_adl_delegue.set_admin_bdtopo_30_option_geom(varchar,varchar,int4) IS '[ADMIN - BDTOPO] - Correction du Type du champs géométrie de la BDTOPO V30
